...
class RegistrarReservaFormTest(TestCase):
    ...
    def test_fecha_desde_antes_de_hoy(self):
        ...
        rango = Rango(fechaDesde=datetime.date.today(), fechaHasta=datetime.date.today()+datetime.timedelta(weeks=6), cab=cab)
        cab.save()
        rango.save()
        fechaDesdeHasta = (datetime.date.today()-datetime.timedelta(days=1)).strftime("%d/%m/%Y") + " - " + (datetime.date.today()+datetime.timedelta(weeks=4)).strftime("%d/%m/%Y")
        foo_slug = "foo_slug"
        form = RegResForm(
            data={
    ...
    def test_fecha_desde_igual_a_hoy(self):
        ...
        cab.save()
        rango.save()
        fechaDesdeHasta = (datetime.date.today()).strftime("%d/%m/%Y") + " - " + (datetime.date.today()+datetime.timedelta(weeks=4)).strftime("%d/%m/%Y")
        foo_slug = "foo_slug"
        form = RegResForm(
            data={
                'fechaDesdeHasta': fechaDesdeHasta,
    ...
    def test_fecha_desde_fuera_de_rango_de_disponibilidad(self):
        ...
        cab.save()
        rango.save()
        fechaDesdeHasta = (datetime.date.today()+datetime.timedelta(weeks=7)).strftime("%d/%m/%Y") + " - " + (datetime.date.today()+datetime.timedelta(weeks=8)).strftime("%d/%m/%Y")
        foo_slug = "foo_slug"
        form = RegResForm(
            data={
                'fechaDesdeHasta': fechaDesdeHasta,
    ...
    def test_fecha_desde_dentro_de_rango_de_una_reserva(self):
        ...
        cab = Cab(nombre="foo_slug", cantHabitaciones=2)
        rango = Rango(fechaDesde=datetime.date.today(), fechaHasta=datetime.date.today()+datetime.timedelta(weeks=6), cab=cab)
        reserva = Reserva(fechaDesde=datetime.date.today()+datetime.timedelta(weeks=2), fechaHasta=datetime.date.today()+datetime.timedelta(weeks=4), cantAdultos=2, cab=cab)
        cab.save()
        rango.save()
        reserva.save()
        fechaDesdeHasta = (datetime.date.today()+datetime.timedelta(weeks=3)).strftime("%d/%m/%Y") + " - " + (datetime.date.today()+datetime.timedelta(weeks=4)).strftime("%d/%m/%Y")
        foo_slug = "foo_slug"
        form = RegResForm(
            data={
                'fechaDesdeHasta': fechaDesdeHasta,
    ...
    def test_fecha_hasta_antes_de_hoy(self):
        ...
        cab.save()
        rango.save()
        fechaDesdeHasta = (datetime.date.today()).strftime("%d/%m/%Y") + " - " + (datetime.date.today()-datetime.timedelta(weeks=1)).strftime("%d/%m/%Y")
        foo_slug = "foo_slug"
        form = RegResForm(
            data={
                'fechaDesdeHasta': fechaDesdeHasta,
    ...
    def test_fecha_hasta_igual_a_hoy(self):
        ...
        cab.save()
        rango.save()
        fechaDesdeHasta = (datetime.date.today()).strftime("%d/%m/%Y") + " - " + (datetime.date.today()).strftime("%d/%m/%Y")
        foo_slug = "foo_slug"
        form = RegResForm(
            data={
                'fechaDesdeHasta': fechaDesdeHasta,
    ...
    def test_fecha_hasta_fuera_de_rango_de_disponibilidad(self):
        ...
        cab.save()
        rango.save()
        fechaDesdeHasta = (datetime.date.today()+datetime.timedelta(weeks=1)).strftime("%d/%m/%Y") + " - " + (datetime.date.today()+datetime.timedelta(weeks=8)).strftime("%d/%m/%Y")
        foo_slug = "foo_slug"
        form = RegResForm(
            data={
                'fechaDesdeHasta': fechaDesdeHasta,
    ...
    def test_fecha_hasta_dentro_de_rango_de_una_reserva(self):
        ...
        rango.save()
        reserva.save()
        fechaDesdeHasta = (datetime.date.today()+datetime.timedelta(weeks=1)).strftime("%d/%m/%Y") + " - " + (datetime.date.today()+datetime.timedelta(weeks=3)).strftime("%d/%m/%Y")
        foo_slug = "foo_slug"
        form = RegResForm(
            data={
                'fechaDesdeHasta': fechaDesdeHasta,
    ...
    def test_fecha_en_rango_ingresado_fuera_de_rango_de_disponibilidad(self):
        ...
        cab = Cab(nombre="foo_slug", cantHabitaciones=2)
        rango1 = Rango(fechaDesde=datetime.date.today(), fechaHasta=datetime.date.today()+datetime.timedelta(weeks=4), cab=cab)
        rango2 = Rango(fechaDesde=datetime.date.today()+datetime.timedelta(weeks=6), fechaHasta=datetime.date.today()+datetime.timedelta(weeks=8), cab=cab)
        cab.save()
        rango1.save()
        rango2.save()
        fechaDesdeHasta = (datetime.date.today()+datetime.timedelta(weeks=1)).strftime("%d/%m/%Y") + " - " + (datetime.date.today()+datetime.timedelta(weeks=7)).strftime("%d/%m/%Y")
        foo_slug = "foo_slug"
        form = RegResForm(
            data={
                'fechaDesdeHasta': fechaDesdeHasta,
    ...
    def test_fecha_en_rango_ingresado_dentro_de_rango_de_una_reserva(self):
        ...
        cab = Cab(nombre="foo_slug", cantHabitaciones=2)
        rango = Rango(fechaDesde=datetime.date.today(), fechaHasta=datetime.date.today()+datetime.timedelta(weeks=5), cab=cab)
        reserva = Reserva(fechaDesde=datetime.date.today()+datetime.timedelta(weeks=2), fechaHasta=datetime.date.today()+datetime.timedelta(weeks=3), cantAdultos=2, cab=cab)
        cab.save()
        rango.save()
        reserva.save()
        fechaDesdeHasta = (datetime.date.today()+datetime.timedelta(weeks=1)).strftime("%d/%m/%Y") + " - " + (datetime.date.today()+datetime.timedelta(weeks=4)).strftime("%d/%m/%Y")
        foo_slug = "foo_slug"
        form = RegResForm(
            data={
                'fechaDesdeHasta': fechaDesdeHasta,
